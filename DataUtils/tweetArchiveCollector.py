...
fileName = "Samsung0802.csv"
fromDateCollect = "202008020000"
toDateCollect = "202008082359"
...
for tweetsPage in tweepy.Cursor(api.search_30_day, tweeterEnvName, queryString, fromDate=fromDateCollect, toDate=toDateCollect).pages(40):
